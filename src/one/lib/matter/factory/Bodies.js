...
(function() {
    ...
    Bodies.rectangle = function(x, y, width, height, options) {
        ...
        return Body_1.create(Common_1.extend({}, rectangle, options));
    };
    ...
    Bodies.trapezoid = function(x, y, width, height, slope, options) {
        ...
        return Body_1.create(Common_1.extend({}, trapezoid, options));
    };
    ...
    Bodies.polygon = function(x, y, sides, radius, options) {
        ...
        return Body_1.create(Common_1.extend({}, polygon, options));
    };
    ...
    Bodies.fromVertices = function(x, y, vertexSets, options, flagInternal, removeCollinear, minimumArea, removeDuplicatePoints) {
        ...
        for (i = 0; i < parts.length; i++) {
            parts[i] = Body_1.create(Common_1.extend(parts[i], options));
        }
                        ...
                        for (k = 0; k < partA.vertices.length; k++) {
                            for (z = 0; z < partB.vertices.length; z++) {
                                ...
                                var da = Vector_1.magnitudeSquared(Vector_1.sub(pav[(k + 1) % pav.length], pbv[z])),
                                    db = Vector_1.magnitudeSquared(Vector_1.sub(pav[k], pbv[(z + 1) % pbv.length]));
        ...
        if (parts.length > 1) {
            ...
            body = Body_1.create(Common_1.extend({ parts: parts.slice(0) }, options));

            // offset such that body.position is at the centre off mass
            Body_1.setPosition(body, { x: x, y: y });
