...
import Bodies_1 from './Bodies.js';
...
var deprecated = Common_1.deprecated;
...
(function() {
        ...
        for (var row = 0; row < rows; row++) {
            ...
            for (var column = 0; column < columns; column++) {
                ...
                if (body) {
                    ...
                    Body_1.translate(body, { x: bodyWidth * 0.5, y: bodyHeight * 0.5 });
    ...
    Composites.pyramid = function(xx, yy, columns, rows, columnGap, rowGap, callback) {
        return Composites.stack(xx, yy, columns, rows, columnGap, rowGap, function(x, y, column, row, lastBody, i) {
            ...
            if (i === 1) {
                Body_1.translate(lastBody, { x: (column + (columns % 2 === 1 ? 1 : -1)) * lastBodyWidth, y: 0 });
            }
    ...
    Composites.car = function(xx, yy, width, height, wheelSize) {
        var group = Body_1.nextGroup(true),
            wheelBase = 20,
