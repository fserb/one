...
(function() {
    ...
    Composite.removeComposite = function(compositeA, compositeB, deep) {
        var position = Common_1.indexOf(compositeA.composites, compositeB);
        if (position !== -1) {
    ...
    Composite.removeBody = function(composite, body, deep) {
        var position = Common_1.indexOf(composite.bodies, body);
        if (position !== -1) {
    ...
    Composite.removeConstraint = function(composite, constraint, deep) {
        var position = Common_1.indexOf(composite.constraints, constraint);
        if (position !== -1) {
    ...
    Composite.translate = function(composite, translation, recursive) {
        ...
        for (var i = 0; i < bodies.length; i++) {
            Body_1.translate(bodies[i], translation);
        }
    ...
    Composite.rotate = function(composite, rotation, point, recursive) {
        ...
        for (var i = 0; i < bodies.length; i++) {
            ...
            Body_1.setPosition(body, {
                x: point.x + (dx * cos - dy * sin),
                y: point.y + (dx * sin + dy * cos)
            });

            Body_1.rotate(body, rotation);
        }
    ...
    Composite.scale = function(composite, scaleX, scaleY, point, recursive) {
        ...
        for (var i = 0; i < bodies.length; i++) {
            ...
            Body_1.scale(body, scaleX, scaleY);
        }
