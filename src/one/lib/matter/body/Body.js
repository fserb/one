...
(function() {
    ...
    Body.create = function(options) {
        var defaults = {
            ...
            plugin: {},
            angle: 0,
            vertices: Vertices_1.fromPath('L 0 0 L 40 0 L 40 40 L 0 40'),
            position: { x: 0, y: 0 },
            force: { x: 0, y: 0 },
            torque: 0,
    ...
    var _initProperties = function(body, options) {
        ...
        // render properties
        var defaultFillStyle = (body.isStatic ? '#14151f' : Common_1.choose(['#f19648', '#f5d259', '#f55a3c', '#063e7b', '#ececd1'])),
    ...
    Body.setVertices = function(body, vertices) {
        ...
        Body.setInertia(body, Body._inertiaScale * Vertices_1.inertia(body.vertices, body.mass));
    ...
    Body.translate = function(body, translation) {
        Body.setPosition(body, Vector_1.add(body.position, translation));
    };
    ...
    Body.scale = function(body, scaleX, scaleY, point) {
        ...
        for (var i = 0; i < body.parts.length; i++) {
            ...
            Body.setInertia(part, Body._inertiaScale * Vertices_1.inertia(part.vertices, part.mass));
            Vertices_1.translate(part.vertices, { x: part.position.x, y: part.position.y });
