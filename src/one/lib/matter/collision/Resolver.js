...
(function() {
    ...
    Resolver.solvePosition = function(pairs, timeScale) {
        var i,
            ...
            contactShare,
            positionImpulse,
            tempA = Vector_1._temp[0],
            tempB = Vector_1._temp[1],
            tempC = Vector_1._temp[2],
            tempD = Vector_1._temp[3];
        ...
        for (i = 0; i < pairs.length; i++) {
            ...
            bodyBtoA = Vector_1.sub(Vector_1.add(bodyB.positionImpulse, bodyB.position, tempA), 
                Vector_1.add(bodyA.positionImpulse, 
                    Vector_1.sub(bodyB.position, collision.penetration, tempB), tempC), tempD);

            pair.separation = Vector_1.dot(normal, bodyBtoA);
        }
