import Sleeping_1 from './Sleeping.js';
...
(function() {
    ...
    Engine.create = function(options) {
        ...
        engine.world = options.world || Composite_1.create({ label: 'World' });
        engine.grid = Grid_1.create(options.grid || options.broadphase);
    ...
    Engine.update = function(engine, delta, correction) {
        ...
        Grid_1.update(grid, allBodies, engine, world.isModified);
        ...
        var collisions = Detector_1.collisions(gridPairs, engine);
        ...
        for (i = 0; i < engine.positionIterations; i++) {
            Resolver_1.solvePosition(pairs.list, timing.timeScale);
        }
        ...
        engine.timing.lastElapsed = Common_1.now() - startTime;
    ...
    Engine.clear = function(engine) {
        ...
        Grid_1.clear(engine.grid);
        Grid_1.update(engine.grid, bodies, engine, true);
    };
    ...
    Engine._bodiesUpdate = function(bodies, deltaTime, timeScale, correction, worldBounds) {
        for (var i = 0; i < bodies.length; i++) {
            ...
            Body_1.update(body, deltaTime, timeScale, correction);
        }
    };
