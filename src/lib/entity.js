 ...
 * registers itself when constructed, and update() runs the groups in draw
 * order once a frame.
 *
 ...
 *   gfx.js    css() and hex(), the two colour helpers a game calls directly
 *
